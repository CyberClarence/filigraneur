...
const e = !(
  ...
  p = { DISABLE: -1, NONE: 0, FREETEXT: 3, HIGHLIGHT: 9, STAMP: 13, INK: 15 },
  g = {
    RESIZE: 1,
    CREATE: 2,
    FREETEXT_SIZE: 11,
  ...
  y = 3,
  w = 4,
  x = { GRAYSCALE_1BPP: 1, RGB_24BPP: 2, RGBA_32BPP: 3 },
  _ = 1,
  E = 2,
  C = 3,
  S = 4,
...
class util_FeatureTest {
  ...
  static get platform() {
    return "undefined" != typeof navigator &&
      ...
      ? shadow(this, "platform", { isMac: navigator.platform.includes("Mac") })
...
class BaseCMapReaderFactory {
  ...
  async fetch({ name: t }) {
    ...
    const e = this.baseUrl + t + (this.isCompressed ? ".bcmap" : ""),
      i = this.isCompressed ? q.BINARY : q.NONE;
...
function setLayerDimensions(t, e, i = !1, s = !0) {
  if (e instanceof PageViewport) {
    const { pageWidth: s, pageHeight: n } = e.rawDims,
      ...
      h = r ? `round(${o}, 1px)` : `calc(${o})`,
      d = r ? `round(${l}, 1px)` : `calc(${l})`;
...
class EditorToolbar {
  ...
  render() {
    ...
    t.addEventListener("pointerdown", EditorToolbar.#o, { signal: e });
  ...
  #l() {
    ...
    t.setAttribute(
      "data-l10n-id",
      `pdfjs-editor-remove-${this.#a.editorType}-button`
    );
    this.#c(t);
    t.addEventListener(
      "click",
...
class HighlightToolbar {
  ...
  show(t, e, i) {
    const [s, n] = this.#f(e, i),
      { style: a } = (this.#s ||= this.#g());
    t.append(this.#s);
...
class AnnotationEditorUIManager {
  ...
  get hcmFilter() {
    return shadow(
      ...
      "hcmFilter",
      this.#tt
        ? this.#z.addHCMFilter(this.#tt.foreground, this.#tt.background)
        : "none"
    );
  }
  get direction() {
  ...
  get highlightColors() {
    return shadow(
      ...
      this.#j
        ? new Map(
            this.#j.split(",").map((t) => t.split("=").map((t) => t.trim()))
          )
        : null
    );
  }
  ...
  highlightSelection(t = "") {
    ...
    if (l) {
      ...
      for (const e of this.#k.values())
        if (e.hasTextLayer(o)) {
          e.createAndAddNewEditor({ x: 0, y: 0 }, !1, {
            methodOfCreation: t,
            boxes: l,
            anchorNode: i,
            anchorOffset: s,
    ...
    if (this.#wt(t).closest(".textLayer")) {
      ...
      if (this.#Q === p.HIGHLIGHT || this.#Q === p.NONE) {
        ...
        if (!this.isShiftKeyDown) {
          ...
          window.addEventListener("pointerup", pointerup, { signal: t });
          window.addEventListener("blur", pointerup, { signal: t });
        }
      }
    } else if (this.#Z) {
      this.#V?.hide();
  ...
  #St() {
    const t = this._signal;
    window.addEventListener("focus", this.#st, { signal: t });
    window.addEventListener("blur", this.#it, { signal: t });
  }
  #Tt() {
  ...
  #yt() {
    const t = this._signal;
    window.addEventListener("keydown", this.#ot, { signal: t });
    window.addEventListener("keyup", this.#lt, { signal: t });
  }
  #Mt() {
  ...
  #kt() {
    const t = this._signal;
    document.addEventListener("copy", this.#nt, { signal: t });
    document.addEventListener("cut", this.#at, { signal: t });
    document.addEventListener("paste", this.#rt, { signal: t });
  }
  #Pt() {
  ...
  showAllEditors(t, e, i = !1) {
    ...
    (this.#et?.get(g.HIGHLIGHT_SHOW_ALL) ?? !0) !== e &&
      this.#Rt([[g.HIGHLIGHT_SHOW_ALL, e]]);
  }
  enableWaiting(t = !1) {
    if (this.#q !== t) {
      this.#q = t;
  ...
  removeEditor(t) {
    ...
    this.#M.delete(t.id);
    this.unselect(t);
    (t.annotationElementId && this.#L.has(t.annotationElementId)) ||
      this.#D?.remove(t.id);
  }
  ...
  #It() {
    ...
    if (1 === this.#M.size)
      for (const t of this.#M.values()) return t.isEmpty();
    return !1;
  }
  delete() {
    this.commitOrRemove();
  ...
  get isEditorHandlingKeyboard() {
    return (
      ...
      (1 === this.#J.size && this.firstSelectedEditor.shouldGetKeyboardEvents())
    );
  }
  isActive(t) {
    return this.#T === t;
  ...
  renderAnnotationElement(t) {
    ...
    i &&
      (this.#Q !== p.NONE || i.hasBeenModified) &&
...
class AltText {
  ...
  async render() {
    ...
    t.className = "altText";
    const e = await AltText._l10nPromise.get(
  ...
  get data() {
    return { altText: this.#Bt, decorative: this.#Ht };
  }
...
class AnnotationEditor {
  ...
  #fe() {
    ...
    for (const i of t) {
      ...
      t.addEventListener("pointerdown", this.#be.bind(this, i), { signal: e });
      t.addEventListener("contextmenu", noContextMenu, { signal: e });
      t.tabIndex = -1;
    }
  ...
  #be(t, e) {
    ...
    this.#Bt?.toggle(!1);
    const s = this.#ve.bind(this, t),
      n = this._isDraggable;
    this._isDraggable = !1;
    const a = this._uiManager._signal,
      r = { passive: !0, capture: !0, signal: a };
  ...
  render() {
    ...
    this.div.addEventListener("focusin", this.#Qt, { signal: t });
    this.div.addEventListener("focusout", this.#Jt, { signal: t });
  ...
  #ye(t) {
    ...
    if (e) {
      ...
      i = { passive: !0, capture: !0, signal: n };
      this.#oe = t.clientX;
      this.#le = t.clientY;
      s = (t) => {
        const { clientX: e, clientY: i } = t,
          [s, n] = this.screenToPageTranslation(e - this.#oe, i - this.#le);
        this.#oe = e;
        this.#le = i;
  ...
  keydown(t) {
    ...
    if (!this.#Gt) {
      ...
      for (const e of this.#Gt) {
        ...
        e.addEventListener("focus", this.#Ee.bind(this, n), { signal: s });
    ...
    if (n !== s) {
      if (n < s)
        for (let t = 0; t < s - n; t++) this.#Kt.append(this.#Kt.firstChild);
      else if (n > s)
        for (let t = 0; t < n - s; t++)
          this.#Kt.firstChild.before(this.#Kt.lastChild);
      let t = 0;
      for (const i of e) {
    ...
    this.#Ce(0);
    this.#ae = !0;
    this.#Kt.firstChild.focus({ focusVisible: !0 });
    t.preventDefault();
  ...
  _resizeWithKeyboard(t, e) {
    this.#ae && this.#ve(this.#te, { movementX: t, movementY: e });
  }
  #ue() {
    this.#ae = !1;
    this.#Ce(-1);
...
class MurmurHash3_64 {
  ...
  hexdigest() {
    ...
    e =
      ((4283543511 * e) & gt) |
      (((2950163797 * ((e << 16) | (t >>> 16))) & gt) >>> 16);
    t ^= e >>> 1;
    t = ((444984403 * t) & gt) | ((60499 * t) & mt);
    e =
      ((3301882366 * e) & gt) |
      (((3120437893 * ((e << 16) | (t >>> 16))) & gt) >>> 16);
    t ^= e >>> 1;
    return (
...
const ft = Object.freeze({ map: null, hash: "", transfer: void 0 });
class AnnotationStorage {
  ...
  get serializable() {
    ...
    return t.size > 0 ? { map: t, hash: e.hexdigest(), transfer: i } : ft;
  }
  get editorStats() {
    let t = null;
    const e = new Map();
...
class PrintAnnotationStorage extends AnnotationStorage {
  ...
  constructor(t) {
    ...
    this.#ke = { map: n, hash: i, transfer: s };
  }
  get print() {
  ...
  getPattern(t, e, i, s) {
    ...
    if (s === yt || s === At) {
      const a = e.current.getClippedPathBoundingBox(
        ...
        l = e.cachedCanvases.getCanvas("pattern", r, o, !0),
        h = l.context;
...
class TilingPattern {
  ...
  createPatternCanvas(t) {
    ...
    const h = i[0],
      ...
      c = i[2],
      u = i[3],
      p = Util.singularValueDecompose2dScale(this.matrix),
      g = Util.singularValueDecompose2dScale(this.baseTransform),
      m = [p[0] * g[0], p[1] * g[1]],
      f = this.getSizeAndScale(s, this.ctx.canvas.width, m[0]),
      b = this.getSizeAndScale(n, this.ctx.canvas.height, m[1]),
      v = t.cachedCanvases.getCanvas("pattern", f.size, b.size, !0),
      A = v.context,
...
const Ct = ["butt", "round", "square"],
  St = ["miter", "round", "bevel"],
  Tt = {},
  Mt = {};
class CanvasGraphics {
  ...
  _createMaskCanvas(t) {
    ...
    return { canvas: v.canvas, offsetX: Math.round(y), offsetY: Math.round(w) };
  }
  setLineWidth(t) {
  ...
  showText(t) {
    ...
    const n = this.ctx,
      ...
      p = i.defaultVMetrics,
      g = s * e.fontMatrix[0],
      m = e.textRenderingMode === f && !i.disableFontFace && !e.patternFill;
    n.save();
    ...
    for (_ = 0; _ < d; ++_) {
      ...
      if (this.contentVisible && (e.isInFont || i.missingFile))
        if (m && !b) n.fillText(f, v, y);
        else {
          this.paintChar(f, v, y, A);
          if (b) {
            const t = v + (s * b.offset.x) / a,
              e = y - (s * b.offset.y) / a;
    ...
    const e = t.streamId,
      ...
      o = {
        enqueue(t, a = 1, r) {
          ...
          n.postMessage(
            { sourceName: i, targetName: s, stream: It, streamId: e, chunk: t },
            r
          );
        },
        close() {
  ...
  constructor(t, e = r) {
    ...
    if (null !== t) {
      ...
      for (const i of t.groups)
        this.#We.set(i.id, new OptionalContentGroup(e, i));
      if ("OFF" === t.baseState)
        for (const t of this.#We.values()) t._setVisible(Ht, !1);
    ...
    fetch(
      ...
      .then((t) => {
        if (!validateResponseStatus(t.status))
          throw createResponseStatusError(t.status, i);
        this._reader = t.body.getReader();
        this._headersCapability.resolve();
        const getResponseHeader = (e) => t.headers.get(e),
          { allowRangeRequests: e, suggestedLength: s } =
...
class PDFFetchStreamRangeReader {
  constructor(t, e, i) {
    ...
    fetch(
      ...
      .then((t) => {
        if (!validateResponseStatus(t.status))
          throw createResponseStatusError(t.status, n);
...
class PDFNetworkStreamFullRequestReader {
  ...
  _onHeadersReceived() {
    const t = this._fullRequestId,
      ...
      { allowRangeRequests: i, suggestedLength: s } =
        validateRangeRequestCapabilities({
          getResponseHeader,
...
class PDFNodeStreamFsFullReader extends BaseFullReader {
  constructor(t) {
    ...
    i.promises.lstat(e).then(
      ...
      (t) => {
        "ENOENT" === t.code &&
          (t = new MissingPDFException(`Missing PDF "${e}".`));
        this._storedError = t;
        this._headersCapability.reject(t);
      }
    );
...
class TextLayer {
  ...
  update({ viewport: t, onBefore: e = null }) {
    ...
    if (s !== this.#ni) {
      e?.();
      this.#ni = s;
      setLayerDimensions(this.#si, { rotation: s });
    }
    if (i !== this.#ai) {
      e?.();
      this.#ai = i;
  ...
  #yi(t) {
    ...
    const r = (this.#Qe && a.fontSubstitution) || a.fontFamily,
      o = Math.hypot(s[2], s[3]),
      l = o * TextLayer.#wi(r, this.#Je);
    let h, d;
    if (0 === n) {
      h = s[4];
      d = s[5] - l;
...
function renderTextLayer() {
  ...
  const {
    ...
    n = Object.keys(s);
  n.length > 0 &&
    warn("Ignoring `renderTextLayer` parameters: " + n.join(", "));
  const a = new TextLayer({ textContentSource: t, container: e, viewport: i }),
    { textDivs: r, textContentItemsStr: o } = a;
  return { promise: a.render(), textDivs: r, textContentItemsStr: o };
}
...
const jt = 65536,
  ...
  Wt = e
    ...
    : class DOMFilterFactory extends BaseFilterFactory {
        ...
        get #Mi() {
          if (!this.#_i) {
            const t = this.#Ci.createElement("div"),
              { style: e } = t;
            e.visibility = "hidden";
            e.contain = "strict";
            e.width = e.height = 0;
        ...
        addFilter(t) {
          ...
          const r = `g_${this.#Ei}_transfer_map_${this.#b++}`,
            o = `url(#${r})`;
          this.#A.set(t, o);
          this.#A.set(a, o);
          const l = this.#Pi(r);
        ...
        addHCMFilter(t, e) {
          ...
          const l = o.join(","),
            h = `g_${this.#Ei}_hcm_filter`,
            d = (n.filter = this.#Pi(h));
          this.#Di(l, l, l, d);
          this.#Ri(d);
          const getSteps = (t, e) => {
            const i = a[t] / 255,
        ...
        addAlphaFilter(t) {
          ...
          const n = `g_${this.#Ei}_alpha_map_${this.#b++}`,
            a = `url(#${n})`;
          this.#A.set(t, a);
          this.#A.set(s, a);
          const r = this.#Pi(n);
        ...
        addLuminosityFilter(t) {
          ...
          const n = `g_${this.#Ei}_luminosity_map_${this.#b++}`,
            a = `url(#${n})`;
          this.#A.set(t, a);
          this.#A.set(i, a);
          const r = this.#Pi(n);
        ...
        addHighlightHCMFilter(t, e, i, s, n) {
          ...
          const getSteps = (t, e, i) => {
            ...
            p = `g_${this.#Ei}_hcm_${t}_filter`,
            g = (r.filter = this.#Pi(p));
          this.#Ri(g);
          this.#Di(
            getSteps(c[0], u[0], 5),
            getSteps(c[1], u[1], 5),
...
function getDocument(t = {}) {
  ...
  const u = t.verbosity,
    ...
    D = !0 === t.pdfBug,
    F = !0 === t.enableHWA,
    R = h ? h.length : t.length ?? NaN,
    I = "boolean" == typeof t.useSystemFonts ? t.useSystemFonts : !e && !E,
    L =
    ...
    O = t.canvasFactory || new $t({ ownerDocument: T, enableHWA: F }),
    N = t.filterFactory || new Wt({ docId: s, ownerDocument: T });
  setVerbosityLevel(u);
  const B = { canvasFactory: O, filterFactory: N };
  if (!L) {
    B.cMapReaderFactory = new f({ baseUrl: g, isCompressed: m });
    B.standardFontDataFactory = new v({ baseUrl: b });
  }
  if (!c) {
      ...
      if (h)
        ...
        l = ((t) => {
          if (e) {
            ...
            })() && isValidFetchUrl(t.url)
              ? new PDFFetchStream(t)
              : new PDFNodeStream(t);
          }
          return isValidFetchUrl(t.url)
            ? new PDFFetchStream(t)
            : new PDFNetworkStream(t);
        })({
          url: n,
          length: R,
          httpHeaders: r,
...
class PDFPageProxy {
  ...
  render({
    ...
    const c = this._transport.getRenderingIntent(i, s, d),
      { renderingIntent: p, cacheKey: g } = c;
    this.#Bi = !1;
    this.#Hi();
    ...
    const v = b.task;
    Promise.all([m.displayReadyCapability.promise, r])
      .then(([t, e]) => {
        if (this.destroyed) complete();
          ...
          b.initializeGraphics({ transparency: t, optionalContentConfig: e });
...
const qt = { isWorkerDisabled: !1, fakeWorkerId: 0 };
if (e) {
...
class PDFWorker {
  ...
  _initialize() {
    ...
    try {
      qt.isSameOrigin(window.location.href, t) ||
        (t = qt.createCDNWrapper(new URL(t, window.location).href));
...
class WorkerTransport {
  ...
  getRenderingIntent(t, e = u.ENABLE, i = null, s = !1) {
    ...
    switch (e) {
      ...
      case u.ENABLE_STORAGE:
        n += h;
        p = (
          n & o && i instanceof PrintAnnotationStorage
            ? i
  ...
  getOptionalContentConfig(t) {
    return this.#Qi("GetOptionalContentConfig").then(
...
class PDFObjects {
  ...
  #Zi(t) {
    return (this.#Ji[t] ||= { ...Promise.withResolvers(), data: Xt });
  }
  get(t, e = null) {
    if (e) {
      const i = this.#Zi(t);
...
class InternalRenderTask {
  ...
  initializeGraphics({ transparency: t = !1, optionalContentConfig: e }) {
    ...
    if (this._canvas) {
      if (InternalRenderTask.#is.has(this._canvas))
        throw new Error(
  ...
  _scheduleNext() {
    this._useRequestAnimationFrame
      ? (this.#es = window.requestAnimationFrame(() => {
          this.#es = null;
...
class AnnotationElement {
  ...
  updateEdited(t) {
    ...
    this.#ss ||= { rect: this.data.rect.slice(0) };
    const { rect: e } = t;
    e && this.#rs(e);
...
class PopupElement {
    ...
    if (this.#vs) {
      ...
      if (
        ...
        t.style.backgroundColor = Util.makeHexColor(
          ...this.#vs.map((t) => Math.floor(e * (255 - t) + t))
        );
      }
    }
    const e = document.createElement("span");
  ...
  #cs(t) {
    t.altKey ||
      ...
      t.ctrlKey ||
      t.metaKey ||
      (("Enter" === t.key || ("Escape" === t.key && this.#Es)) && this.#bs());
  }
  updateEdited({ rect: t, popupContent: e }) {
    this.#ss ||= { contentsObj: this.#As, richText: this.#Ts };
    t && (this.#E = null);
    if (e) {
      this.#Ts = this.#Rs(e);
      this.#As = null;
...
class LineAnnotationElement extends AnnotationElement {
  ...
  render() {
    ...
    const t = this.data,
      ...
      n = (this.#Ls = this.svgFactory.createElement("svg:line"));
...
class SquareAnnotationElement extends AnnotationElement {
  ...
  render() {
    ...
    const t = this.data,
      ...
      a = (this.#Os = this.svgFactory.createElement("svg:rect"));
...
class CircleAnnotationElement extends AnnotationElement {
  ...
  render() {
    ...
    const t = this.data,
      ...
      s = this.svgFactory.create(e, i, !0),
      n = t.borderStyle.width,
      a = (this.#Ns = this.svgFactory.createElement("svg:ellipse"));
...
class FreeTextEditor extends AnnotationEditor {
  ...
  get propertiesToUpdate() {
    return [
      [g.FREETEXT_SIZE, this.#Ds],
      [g.FREETEXT_COLOR, this.#vs],
    ];
  }
  #en(t) {
    const setFontsize = (t) => {
  ...
  enableEditMode() {
    ...
    const t = this._uiManager._signal;
    this.editorDiv.addEventListener("keydown", this.#Ys, { signal: t });
    this.editorDiv.addEventListener("focus", this.#Xs, { signal: t });
    this.editorDiv.addEventListener("blur", this.#qs, { signal: t });
    this.editorDiv.addEventListener("input", this.#Ks, { signal: t });
    this.editorDiv.addEventListener("paste", this.#Qs, { signal: t });
  }
  disableEditMode() {
    ...
    if (r.nodeType === Node.TEXT_NODE) {
      ...
      if (t !== this.editorDiv) {
        ...
        for (const i of this.editorDiv.childNodes)
          i !== t ? e.push(FreeTextEditor.#an(i)) : (e = h);
      }
  ...
  serialize(t = !1) {
    ...
    const e = FreeTextEditor._internalPadding * this.parentScale,
      ...
      s = AnnotationEditor._colorManager.convert(
        this.isAttachedToDOM ? getComputedStyle(this.editorDiv).color : this.#vs
      ),
      n = {
        annotationType: p.FREETEXT,
        color: s,
  ...
  renderAnnotationElement(t) {
    ...
    t.updateEdited({ rect: this.getRect(s, s), popupContent: this.#Js });
    return e;
  }
  resetAnnotationElement(t) {
...
class Outliner {
  ...
  constructor(t, e = 0, i = 0, s = !0) {
    ...
    this.#dn = { x: c, y: u, width: h, height: d, lastPoint: g };
  }
  getOutlines() {
    this.#cn.sort((t, e) => t[0] - e[0] || t[1] - e[1] || t[2] - e[2]);
    const t = [];
    for (const e of this.#cn)
      if (e[3]) {
        t.push(...this.#pn(e));
        this.#gn(e);
      } else {
...
class FreeOutliner {
  ...
  constructor({ x: t, y: e }, i, s, n, a, r = 0) {
    ...
    this.#kn = n * s;
    this.#wn = a;
    this.#_n.set([NaN, NaN, NaN, NaN, t, e], 6);
    this.#yn = r;
  ...
  #In() {
    const t = this.#_n.subarray(4, 6),
      e = this.#_n.subarray(16, 18),
      [i, s, n, a] = this.#dn;
    return [
  ...
  toSVGPath() {
    ...
    const t = this.#xn,
      e = this.#An,
      i = this.#_n.subarray(4, 6),
      s = this.#_n.subarray(16, 18),
      [n, a, r, o] = this.#dn,
      [l, h, d, c] = this.#In();
    if (isNaN(this.#_n[6]) && !this.isEmpty())
      return `M${(this.#_n[2] - n) / r} ${(this.#_n[3] - a) / o} L${
        (this.#_n[4] - n) / r
      } ${(this.#_n[5] - a) / o} L${l} ${h} L${d} ${c} L${
        (this.#_n[16] - n) / r
      } ${(this.#_n[17] - a) / o} L${(this.#_n[14] - n) / r} ${
        (this.#_n[15] - a) / o
      } Z`;
    const u = [];
    u.push(`M${t[4]} ${t[5]}`);
  ...
  getOutlines() {
    const t = this.#xn,
      ...
      n = i.subarray(16, 18),
      [a, r, o, l] = this.#dn,
      h = new Float64Array((this.#Pn?.length ?? 0) + 2);
...
class FreeHighlightOutline extends Outline {
  ...
  toSVGPath() {
    const t = [`M${this.#On[4]} ${this.#On[5]}`];
    for (let e = 6, i = this.#On.length; e < i; e += 6)
      isNaN(this.#On[e])
        ? t.push(`L${this.#On[e + 4]} ${this.#On[e + 5]}`)
        : t.push(
            `C${this.#On[e]} ${this.#On[e + 1]} ${this.#On[e + 2]} ${
              this.#On[e + 3]
            } ${this.#On[e + 4]} ${this.#On[e + 5]}`
          );
    t.push("Z");
    return t.join(" ");
  }
  ...
  #Nn(t) {
    ...
    const c = n - this.#yn,
      ...
      p = r - n + 2 * this.#yn,
      g = o - a + 2 * this.#yn;
    this.#Ln = { x: c, y: u, width: p, height: g, lastPoint: [l, h] };
  }
  get box() {
    return this.#Ln;
  }
  getNewOutline(t, e) {
    const { x: i, y: s, width: n, height: a } = this.#Ln,
      [r, o, l, h] = this.#dn,
      d = n * l,
      c = a * h,
      u = i * l + r,
      p = s * h + o,
      g = new FreeOutliner(
        { x: this.#Pn[0] * d + u, y: this.#Pn[1] * c + p },
        this.#dn,
        this.#Mn,
        t,
        this.#wn,
    ...
    for (let t = 2; t < this.#Pn.length; t += 2)
      g.add({ x: this.#Pn[t] * d + u, y: this.#Pn[t + 1] * c + p });
...
class ColorPicker {
  ...
  constructor({ editor: t = null, uiManager: e = null }) {
    ...
    this.#$n =
      t?.color || this.#p?.highlightColors.values().next().value || "#FFFF98";
  }
  renderButton() {
    ...
    t.addEventListener("click", this.#Kn.bind(this), { signal: e });
    t.addEventListener("keydown", this.#ds, { signal: e });
  ...
  #Yn() {
    ...
    for (const [i, s] of this.#p.highlightColors) {
      ...
      n.addEventListener("click", this.#Qn.bind(this, s), { signal: e });
      t.append(n);
    }
    t.addEventListener("keydown", this.#ds, { signal: e });
    return t;
  ...
  _hideDropdownFromKeyboard() {
    if (!this.#Gn)
      if (this.#Jn) {
        this.hideDropdown();
        this.#Un.focus({ preventScroll: !0, focusVisible: this.#Wn });
  ...
  updateColor(t) {
    ...
    for (const i of this.#Vn.children)
...
class HighlightEditor extends AnnotationEditor {
  ...
  #ba() {
    const t = new Outliner(this.#ea, 0.001);
    ...
    this.#da = [(i[0] - this.x) / this.width, (i[1] - this.y) / this.height];
  }
  #ma({ highlightOutlines: t, highlightId: e, clipPathId: i }) {
    this.#oa = t;
    this.#sa = t.getNewOutline(this.#kn / 2 + 1.5, 0.0025);
    if (e >= 0) {
      this.#b = e;
      this.#ia = i;
      ...
      this.parent.drawLayer.updateBox(
        this.#b,
        HighlightEditor.#va(this.#oa.box, (e - this.rotation + 360) % 360)
      );
      this.parent.drawLayer.updateLine(this.#ua, this.#sa);
      this.parent.drawLayer.updateBox(
        this.#ua,
        HighlightEditor.#va(this.#sa.box, e)
      );
    }
  ...
  static get defaultPropertiesToUpdate() {
    return [
      [g.HIGHLIGHT_DEFAULT_COLOR, HighlightEditor._defaultColor],
  ...
  get propertiesToUpdate() {
    return [
      ...
      [g.HIGHLIGHT_THICKNESS, this.#kn || HighlightEditor._defaultThickness],
      [g.HIGHLIGHT_FREE, this.#la],
    ];
  }
  #in(t) {
    const setColor = (t) => {
  ...
  #ya(t) {
    if (!this.#la) return;
    this.#ma({ highlightOutlines: this.#oa.getNewOutline(t / 2) });
    this.fixAndSetPosition();
    const [e, i] = this.parentDimensions;
  ...
  #fa(t = this.parent) {
    if (null === this.#b) {
      ({ id: this.#b, clipPathId: this.#ia } = t.drawLayer.highlight(
        this.#oa,
        this.color,
        this.#ca
      ));
  ...
  render() {
    ...
    this.#la
      ...
      : this.div.addEventListener("keydown", this.#ot, {
    ...
    bindEvents(this, this.#ra, ["pointerover", "pointerleave"]);
    this.enableEditing();
    return t;
  }
  pointerover() {
  ...
  static startHighlighting(t, e, { target: i, x: s, y: n }) {
    const { x: a, y: r, width: o, height: l } = i.getBoundingClientRect(),
      ...
      h = t._signal,
      d = { capture: !0, passive: !1, signal: h },
      pointerDown = (t) => {
        t.preventDefault();
        t.stopPropagation();
      },
    ...
    window.addEventListener("blur", pointerUpCallback, { signal: h });
    window.addEventListener("pointerup", pointerUpCallback, { signal: h });
    window.addEventListener("pointerdown", pointerDown, d);
    window.addEventListener("contextmenu", noContextMenu, { signal: h });
    i.addEventListener("pointermove", pointerMove, { signal: h });
...
class InkEditor extends AnnotationEditor {
  ...
  static get defaultPropertiesToUpdate() {
    return [
      [g.INK_THICKNESS, InkEditor._defaultThickness],
      [
        g.INK_COLOR,
        InkEditor._defaultColor || AnnotationEditor._defaultLineColor,
      ],
      [g.INK_OPACITY, Math.round(100 * InkEditor._defaultOpacity)],
    ];
  }
  get propertiesToUpdate() {
    return [
      [g.INK_THICKNESS, this.thickness || InkEditor._defaultThickness],
      [
        g.INK_COLOR,
        this.color ||
  ...
  #Qa(t, e) {
    ...
    this.canvas.addEventListener("contextmenu", noContextMenu, { signal: i });
    this.canvas.addEventListener("pointerleave", this.#Da, { signal: i });
    this.canvas.addEventListener("pointermove", this.#Pa, { signal: i });
    this.canvas.addEventListener("pointerup", this.#Fa, { signal: i });
    this.canvas.removeEventListener("pointerdown", this.#Ra);
    this.isEditing = !0;
    if (!this.#Ba) {
      this.#Ba = !0;
  ...
  #Va(t = !1) {
    ...
    const s = Math.ceil(i + this.#ka * this.scaleFactor),
      n = Math.ceil(i + this.#Ma * this.scaleFactor),
...
class StampEditor extends AnnotationEditor {
  ...
  static paste(t, e) {
    e.pasteEditor(p.STAMP, { bitmapFile: t.getAsFile() });
  }
  #_r(t, e = !1) {
    if (t) {
      this.#pr = t.bitmap;
  ...
  #Cr() {
    ...
    if (this.#fr) {
      ...
      this.#fr = null;
      this._uiManager.enableWaiting(!0);
      this.#mr = this._uiManager.imageManager
        .getFromUrl(t)
        .then((t) => this.#_r(t))
        .finally(() => this.#Er());
      return;
      ...
      this._uiManager
        ...
        .then((t) => {
          ...
          this.parent &&
            e &&
            !this.hasAltText() &&
            (this.altTextData = { altText: e, decorative: !1 });
        });
    }
...
class AnnotationEditorLayer {
  ...
  constructor({
    ...
    const h = [...AnnotationEditorLayer.#N.values()];
  ...
  updateMode(t = this.#p.getMode()) {
    ...
    for (const i of AnnotationEditorLayer.#N.values())
  ...
  disable() {
    ...
    for (const t of AnnotationEditorLayer.#N.values())
  ...
  #jr(t) {
    ...
    if (t.target === this.#zr.div) {
      ...
      this.#zr.div.addEventListener(
        "pointerup",
        () => {
          this.#zr.div.classList.remove("free");
        },
        { once: !0, signal: this.#p._signal }
      );
      t.preventDefault();
    }
  }
  enableClick() {
    ...
    this.div.addEventListener("pointerdown", this.#Rr, { signal: t });
    this.div.addEventListener("pointerup", this.#Fr, { signal: t });
  }
  disableClick() {
    if (this.#Rr) {
  ...
  attach(t) {
    ...
    e &&
      this.#p.isDeletedAnnotationElement(e) &&
      this.#p.removeDeletedAnnotationElement(t);
  }
  detach(t) {
    this.#Or.delete(t.id);
    ...
    !this.#Hr &&
      ...
      this.#p.addDeletedAnnotationElement(t);
  }
  remove(t) {
    this.detach(t);
  ...
  moveEditorInDOM(t) {
    ...
    t._structTreeParentId = this.#js?.moveElementInDOM(
      this.div,
      t.div,
      t.contentDiv,
      !0
  ...
  pasteEditor(t, e) {
    this.#p.updateToolbar(t);
    this.#p.updateMode(t);
    const { offsetX: i, offsetY: s } = this.#Wr(),
      n = this.getNextId(),
      a = this.#Vr({
        parent: this,
        id: n,
...
var te = __webpack_exports__.AbortException,
  ...
  be = __webpack_exports__.Outliner,
  ve = __webpack_exports__.PDFDataRangeTransport,
  ...
  De = __webpack_exports__.createValidAbsoluteUrl,
  Fe = __webpack_exports__.fetchData,
  ...
  Ne = __webpack_exports__.isDataScheme,
  Be = __webpack_exports__.isPdfFile,
  He = __webpack_exports__.noContextMenu,
  ze = __webpack_exports__.normalizeUnicode,
  Ue = __webpack_exports__.renderTextLayer,
  je = __webpack_exports__.setLayerDimensions,
  $e = __webpack_exports__.shadow,
  Ve = __webpack_exports__.updateTextLayer,
...
export {
  ...
  Ue as renderTextLayer,
  je as setLayerDimensions,
  $e as shadow,
  Ve as updateTextLayer,
  We as version,
};
